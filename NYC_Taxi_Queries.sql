...
-- Notes:
-- • December 2022 is incomplete (57 rows). For time-series questions (Q4, Q7) I exclude month 12.
-- • NULL tip_amount is kept (cash tips are expected and should not be imputed).
-- • For Q2/Q3 revenue-type calculations, I apply reasonable outlier caps to prevent corrupted values dominating averages.
...
-- Here I assume QX = Q2 (Jul–Sep) based on the dataset output.
--------------------------------------------------------------------------------
WITH si_q2 AS (
 SELECT
 z.zone_name AS pickup_zone,
